...
scarf_call() {
    # Telemetry disabled for Goswitch
    :
}
...
print_access_info() {
    printf "${BLUE}"
    printf "╔════════════════════════════════════════════════════════════════╗\n"
    printf "║             Welcome to Goswitch Infrastructure!                ║\n"
    printf "╚════════════════════════════════════════════════════════════════╝\n"
    printf "${NC}\n"

    printf "${GREEN}${BOLD}Setup complete! You can now access Goswitch services at:${NC}\n"
    ...
    printf "            Email:    admin@goswitch.in\n"
    ...
    printf "\n"
    printf "Reach out to us on ${BLUE}https://goswitch.in${NC} in case you face any issues.\n"
}
